<?php 
	...
	if (isset($_SESSION['access_token'])):
		...
		$checkOwner = "SELECT * FROM blog WHERE writer_id = '$userID' AND id = '$postID'";
		$match = mysqli_num_rows(mysqli_query($conn,$checkOwner));
		// check if the changes is from the original owner
		if ($match > 0):
