<?php if ($key['isAllowed'] == 1998 || $key['writer_id'] == $_SESSION['OAuthID'] || isset($_SESSION['petme_administrator'])): ?>
		...
		<div class="card-body p-1 activity-image-card">
		 	<div class="row">
		 		...
		 		<div class="col-7 col-lg-6 align-self-center">
		 			...
		 			<a href="blog/<?php echo $key['seoTitle']; ?>"><button class="theme-btn btn-style-three py-1 my-3" style="display: block;">Read More</button></a>
		 		</div>
		 	</div>
